...
test('purchase → unpaid rejection → paid → failed generation → retry → private repeat download',async()=>{
 ...
 try {
 const input={description:'Replace timber fencing with two workers',address:'Example site address',company:'Test Company',companyAddress:'',contact:'',emergency:'',reviewAccepted:true,processingAccepted:true};
