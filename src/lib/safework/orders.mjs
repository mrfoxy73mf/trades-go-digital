...
export function validateInput(body) {
 ...
 return { description: text('description', 8, 12000), address: text('address', 5, 500), company: text('company', 1, 200), companyAddress: text('companyAddress', 0, 500), contact: text('contact', 0, 200), emergency: text('emergency', 0, 1500) };
}
