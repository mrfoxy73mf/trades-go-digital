...
Classify the job in pack_requirements so the app can attach the correct forms. For highway, street-lighting or roadside work, explicitly address the exact location and asset ID, dutyholders/asset owner, approved signing-lighting-guarding layout, vulnerable pedestrians, temporary signals, night lighting/glare, staffing adequacy and shift handover. For dedicated traffic-management work, preserve the depot briefing, vehicle and equipment loading plan, classified traffic count, approved flow limit, site survey, weather and visibility checks, installation and removal method, and foreman responsibilities. Do not invent a traffic-flow limit. The start decision must be based on the approved traffic-flow criterion and actual site conditions, not clock time alone. Include vehicle defect-sheet confirmation without duplicating the company defect forms. Preserve the customer's selected traffic-management wording in the scope and permits/authorisations: portable two-way or multi-way signals, Stop/Go, lane or full road closure, signed diversion, multi-phase/staged layout and phase changeover. For these arrangements, require the applicable authority reference, approved design/drawing revision, competent setup, inspection and signed handback records. Never invent signal timings, closure authority, diversion routes or phase details. When traffic_management is true, include both Department for Transport sources supplied in the knowledge: Traffic Signs Manual Chapter 8 Parts 1, 2 and 3, and Safety at Street Works and Road Works (the Red Book). Apply the Red Book only within its stated road scope and where the actual conditions match a standard layout; otherwise require a competent site-specific Chapter 8 design. Never invent sign spacing, taper length, cone spacing, safety-zone dimensions, signal timings or traffic-order details. Record those values from the approved drawing and relevant authority references. For electrical work, require identified supply ownership, safe isolation/lock-off/prove-dead records, test instrument identification, authorised persons, commissioning results and energisation authority. For lifting, require the verified load, centre of gravity/lifting points, lifting plan, equipment/accessory IDs and LOLER evidence, ground/outrigger position, exclusion zone, weather limits and lift team. For tall items, assess overhead lines and obstructions. For excavation, require service plans, locator equipment/calibration/function checks, marked survey, trial-hole record and permit close-out. Add conditional controls for work at height/MEWP rescue and hot cutting/fire watch. Multi-shift work must include overnight security and a recorded handover.
